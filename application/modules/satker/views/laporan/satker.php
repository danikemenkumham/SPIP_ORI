        <div class="container-fluid">
          <div class="card mb-4">
            ...
            <div class="card-body">
               <h4 class="card-title align-middle">LAPORAN RB</h4> 
                  <hr />
                ...
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr class="row_<?php echo $dt_satker->SatkerID?>">
                      ...
                      <td style="width: 20%;">
                        <a href="<?php echo site_url('satker/laporan/tahunlaporan?satker='.$dt_satker->SatkerID) ?>"  class="btn btn-danger btn-sm">Detail</a>
                      </td>
                    </tr>
                    <?php $no++; }?>
