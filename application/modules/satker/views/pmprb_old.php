                                                               ...
                                                               <?php if($data_dukung->num_rows() > 0){?>
                                                                ...
                                                                <tr>
                                                                    <td colspan="3">
                                                                        ...
                                                                        <button type="button" class="btn btn-xs btn-info catatan" data-satker="<?php echo $dt_poin->iduser?>" data-detail="<?php echo $dt_poin->id_detail_pmprb_user?>">Kirim</button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                           </td>
