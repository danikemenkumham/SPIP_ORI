                  ...
                  <tbody>
                    ...
                    <tr class="row_<?php echo $dt_satker->SatkerID?>">
                      ...
                      <td style="width: 20%;">
                        ...
                        <a target="_blank" href="<?php echo site_url('satker/wbk/paper/'.$dt_satker->SatkerID)?>" class="btn btn-success btn-sm"><small class="text-white"><i class="mdi-printer mdi" style="font-size: 1em;"></i></small></a>
                      </td>
                    </tr>
                    <?php $no++; }?>
