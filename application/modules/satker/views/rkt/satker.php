                ...
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr class="row_<?php echo $dt_satker->SatkerID?>">
                      ...
                      <td style="width: 20%;">
                        <a href="<?php echo site_url('satker/rkt/area/2020/'.$dt_satker->SatkerID) ?>"  class="btn btn-danger btn-sm">Detail</a>
                        <a target="_blank" href="<?php echo site_url('satker/rkt/paper/'.$dt_satker->SatkerID)?>" class="btn btn-success btn-sm"><small class="text-white"><i class="mdi-printer mdi" style="font-size: 1em;"></i></small></a>
                      </td>
                    </tr>
                    <?php $no++; }?>
