    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <?php if($this->session->userdata('role') == 5){ ?>
                    <li class="breadcrumb-item"><a href="<?php echo site_url('satker/rkt/area/'.$this->session->userdata('tahun'))?>">RKT</a></li>
                                                            ...
                                                            <?php }?>  
                                                                          ...
                                                                          <?php if($status_lengkap->row()->status != 'lengkap'){?>
                                                                                <?php 
                                                                                        foreach($waktu->result() as $dt_waktu){
                                                                                            if($dt_waktu->kodewaktu == $dt_poin->waktu_pelaksanaan){
                                                                                              //check on upload date
                                                                                            $start_date = $dt_waktu->start_upload;
                                                                                            $end_date = $dt_waktu->end_upload;
                                                                                            ...
                                                                                            // check jika masuk dalam tanggal uplaod
                                                                ...
                                                                <tr>
                                                                    <td colspan="5">
                                                                        ...
                                                                        <ul class="list-unstyled con_catatan<?php echo $dt_poin->waktu_pelaksanaan?>">  
                                                                           <?php $catatan = modules::run('satker/rkt/get_catatan',$dt_poin->id_rkt_user, $dt_poin->waktu_pelaksanaan)?>
                                                                        ...
                                                                        <div class="form-group bg-white p-2 border">
                                                                            <label>Catatan :</label>
                                                                            <textarea class="form-control catatan<?php echo $dt_poin->waktu_pelaksanaan?>" name="catatan<?php echo $dt_poin->waktu_pelaksanaan;?>"  rows="2" ></textarea>
                                                                        </div>
                                                                        <button type="button" class="btn btn-xs btn-info catatan" data-ref="<?php echo $dt_poin->waktu_pelaksanaan ?>" data-satker="<?php echo $dt_poin->iduser?>" data-detail="<?php echo $dt_poin->id_rkt_user?>">Kirim</button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                           </td>
