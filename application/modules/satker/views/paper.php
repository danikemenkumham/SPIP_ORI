...
<b style="font-size: 30px; text-align: center; ">PEMENUHAN DATA DUKUNG PMPRB <?php echo $this->session->userdata('tahun')?> <br /> 
...
<div class="">
            <?php
            $kategori_penilaian = modules::run('satker/pmprb/get_kategori_penilaian_cetak', $this->uri->segment(4), $dt_pmprb->id_area);
                    ...
                    <table class="table" style="margin-top: 25px;">
                        ...
                        <tr style="background-color: #0FA5D7; color: white;">
                            <td colspan="5" style="font-size: 14px;">
                             Area Perubahan         : <?php echo  ucwords(strtolower($dt_pmprb->nama_area));?> <br />
                             Kategori Penilaian : <?php echo $dt_kategori->kategori_penilaian;?> <br />
                                 <?php 
                                        ...
                                        $daduk =  modules::run('satker/pmprb/count_pmprb_cetak', $dt_kategori->id_pmprb,$satker);    
                        ...
                        <tr>
                            <th style="width: 25%; border:1px solid black">Poin Penilaian</th>
                        ...
                        <tr>
                                    <td style="border:1px solid black"><p><?php echo $dt_poin->objek_penilaian?> </p></td>
                                    <td style="border:1px solid black"><p><?php echo nl2br($dt_poin->penjelasan)?></p></td>
                                    <td style="border:1px solid black"><p><?php echo nl2br($dt_poin->data_dukung)?></p></td>
                                    ...
                                    <td style="border:1px solid black; text-align: center;">
                                        <?php
                                            $status_lengkap = modules::run('satker/pmprb/get_status_penilaian', $dt_poin->id_detail_pmprb_user);
