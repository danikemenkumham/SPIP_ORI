        ...
        <nav aria-label="breadcrumb ">
          <ol class="breadcrumb ">
             <?php if($this->session->userdata('role') == 5){ ?>
                    <li class="breadcrumb-item"><a href="<?php echo current_url()?>">PMPRB</a></li>
           <?php  }else{?>
         ...
         <h4 class="text-center bg-info rounded p-3 text-white mb-3">AREA PERUBAHAN PMPRB</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 grid-margin stretch-card">
              ...
              <div class="card rounded area" data-satker="<?php echo $last_uri[count($last_uri)];?>" data-ref="<?php echo $dt_area->id_area?>">
                  <div class="card-body text-center p-2 bg-success rounded">
                      <?php 
                      ...
                      $new_upload =  modules::run('satker/pmprb/count_pmprb_area_upload_new', $dt_area->id_area,$satker);
                      if($new_upload != 0){
                        echo ' <div class="badge badge-pill badge-light" style="position: absolute; right: 5px; top:5px"><b>'.$new_upload.'</b></div>';
                      }
                      ?>
                    <img style="width: 64px;" src="<?php echo base_url()?>assets/image/lkp.png" class="img-fluid" />
                   ...
                   <?php
                      ...
                      echo modules::run('satker/pmprb/count_pmprb_area', $dt_area->id_area,$satker );
                      ?>
                  </div>
