<div class="row">
            <div class="col-md-12 grid-margin bg-in ">
              <div class="d-flex justify-content-between flex-wrap bg-info p-3 rounded">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5 text-white">
                    <h4>
                        <?php echo modules::run('dashboard/get_nama_satker', $this->uri->segment(3))?>
                    </h4>
                    <p class="mb-md-0">Dashboard pemenuhan data dukung kegiatan Reformasi Birokrasi Kemenkumham RI</p>
                  </div>
                </div>          
              </div>
            </div>
        ...
        <div class="card-body">
          ...
          <div class="row px-2 template-demo">
                ...
                ?>
                 ...
                 <?php
                    $count = Modules::run('dashboard/count_lke_area', $dt_area->id_area, $this->uri->segment(3));
                    $speedo = $count*3-300;
                 ?>
                  ...
                  <div class="template-demo">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                      <small><b class="text-secondary"><?php echo ucwords(strtolower($dt_pmprb->nama_area));?></b></small>
                       <?php
                            $count = Modules::run('dashboard/count_pmprb_area', $dt_pmprb->id_area, $this->uri->segment(3));
                       ?>
        ...
        <div class="card-body">
          ...
          <div class="template-demo">
            ...
            <div class="d-flex justify-content-between mt-2">
              ...
              <?php
                    $count = Modules::run('dashboard/count_rkt_area', $dt_rkt->id_area,$this->uri->segment(3));
               ?>
              <small class="text-secondary"><?php echo $count; ?>%</small>
            </div>
            <div class="progress progress-sm mt-2">
