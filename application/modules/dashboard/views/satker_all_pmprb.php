              ...
              <div class="d-flex justify-content-between flex-wrap bg-primary p-3 rounded">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5 text-white">
                    ...
                    <p class="mb-md-0">Progress pemenuhan LKP PMPRB untuk semua Satuan Kerja di Kemenkumham</p>
                  </div>
                </div>          
              </div>
            </div>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
               <h2 class="card-title align-middle text-center">Pemenuhan LKP PMPRB Semua Satuan Kerja</h2> 
               <hr />
