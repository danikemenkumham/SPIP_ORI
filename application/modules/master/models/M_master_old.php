...
class M_master extends CI_Model {
    ...
    public function tambah_area_perubahan(){
        $this->db->set('nama_area',$this->input->post('perubahan'));
        $this->db->set('keterangan_area',$this->input->post('keterangan'));
        $this->db->set('tahun_area',$this->input->post('tahun'));
       // $this->db->set('kode_area',$this->input->post('kode'));
        $this->db->set('id_program',$this->input->post('program'));
    ...
    public function tambah_program(){
        $this->db->set('nama_program',$this->input->post('program'));
        $this->db->set('kode_program',$this->input->post('kode'));
    ...
    public function tambah_wbk(){
        $this->db->set('indikator',$this->input->post('indikator'));
    ...
    public function get_wbk_limit($perpage,$offset){
        $this->db->join( $this->tb_area_perubahan.' ap',  'ap.id_area = tw.id_area');
         ...
         if($this->input->get('q')){
            $this->db->like('indikator',$this->input->get('q'));
        }
        $this->db->order_by('nama_area', 'asc');
        $this->db->limit($perpage, $offset);  
    ...
    public function tambah_pmprb(){
        $this->db->set('kategori_penilaian',$this->input->post('kategori_penilaian'));
    ...
    public function get_pmprb(){
        $this->db->join( $this->tb_area_perubahan.' ap',  'ap.id_area = tw.id_area');
        if($this->input->get('q')){
            $this->db->like('kategori_penilaian',$this->input->get('q'));
        }
    ...
    public function tambah_pelaksanaan(){
        $this->db->set('waktu_pelaksanaan',$this->input->post('waktu_pelaksanaan'));
        $this->db->set('kode_waktu_pelaksanaan',$this->input->post('kode_waktu_pelaksanaan'));
    ...
    public function tambah_kegiatan(){
         $this->db->set('kode_kegiatan',$this->input->post('kode'));
        $this->db->set('nama_kegiatan',$this->input->post('kegiatan'));
        $this->db->set('indikator_keberhasilan',$this->input->post('indikator'));
        $this->db->set('data_dukung',$this->input->post('data_dukung'));
        $this->db->set('penanggung_jawab',$this->input->post('penanggung_jawab'));
        $this->db->set('id_capaian',$this->input->post('capaian'));
    ...
    public function tambah_user(){
        ...
        $this->db->set('satker_id',$this->input->post('satker'));
		$options = array(
			'cost' => 12,
		);
    ...
    public function tambah_rincian_pmprb(){
        ...
        $this->db->set('penjelasan', $this->input->post('penjelasan'));
         $this->db->set('objek_penilaian', $this->input->post('objek_penilaian'));
        $this->db->set('id_pmprb', $this->input->post('pmprb'));
    ...
    public function get_rincian_wbk_limit($perpage,$offset){
     ...
     public function tambah_rincian_wbk(){
        ...
        $this->db->set('daduk', $this->input->post('daduk'));
        $this->db->set('poin_indikator', $this->input->post('poin_indikator'));
        $this->db->set('juknis', $this->input->post('juknis'));
        $this->db->set('id_wbk', $this->input->post('wbk'));
    ...
    //rkt model
     public function get_rkt(){
        ...
        if($this->input->get('q')){
            $this->db->like('kegiatan',$this->input->get('q'));
        }
    ...
    public function add_satker_detail_rkt(){
        $this->db->set('iduser', $this->input->post('satker'));
        $this->db->set('id_rkt', $this->input->post('detail'));
        $this->db->insert($this->tb_user_rkt);
    }
