                ...
                <div class="card-body">
                  ...
                  <div class="template-demo">
                    ...
                    <div class="progress progress-sm mt-2">
                      <div class="progress-bar bg-<?php echo $color?>" role="progressbar" style="width: <?php echo $count?>%" aria-valuenow="<?php echo $count?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <?php }?>
                  </div>
                </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="template-demo">
            ...
            <div class="progress progress-sm mt-2">
              <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $count?>%" aria-valuenow="<?php echo $count?>" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <?php }?>
