                            <div class="card-body p-0">
                                <h4 class="card-title align-middle text-center">Survey IKM Unit Pusat</h4>   
                                      <div class="table-responsive mt-3">
                                        <table class="table table-striped rounded"  width="100%" cellspacing="0">
                                              ...
                                              <?php
                                              $no=0;
                                               foreach($ikm as $dt_result){
                                                    if(($dt_result->kode_eselon >= '01' && $dt_result->kode_eselon <= '17' ) && $dt_result->weight_name == 'IKM' && ($dt_result->kode_eselon != '05' && $dt_result->kode_eselon != '06' && $dt_result->kode_eselon != '03' && $dt_result->kode_eselon != '12' )){
                                                    $no = $no+1;
                                              ?>
                                              <tr>
                                    ...
                                    <h4 class="card-title align-middle text-center mt-5">Survey IKM Kantor Wilayah</h4>   
                                      <div class="table-responsive mt-3">
                                        <table class="table table-striped rounded"  width="100%" cellspacing="0">
                                              ...
                                              $no=0;
                                               foreach($ikm as $dt_result){
                                                    if($dt_result->kode_eselon == '1301' && $dt_result->weight_name == 'IKM'){
                                                     $no = $no+1;
                                              ?>
                                              <tr>
                                                  <td class="py-1 text-center"><?php echo $no?></td>
                                                  <td><b  data-ref="<?php echo $dt_result->kode_wilayah?>" class="ikm_modal" style="cursor: pointer;" data-toggle="modal" data-target="#modal_"><?php echo $dt_result->subject_organization?></b></td>
                                                  <td class="text-center"><b><?php echo $dt_result->respondent_count?></b></td>
                                                  <!-- 
                                                  <td class="text-center">
