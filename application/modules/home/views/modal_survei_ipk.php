<h4 class="card-title align-middle text-center ">Survey IPK Kantor Wilayah</h4>   
    <nav class="mt-3">
                ...
                <table class="table table-striped rounded"  width="100%" cellspacing="0">
                      ...
                      $no=0;
                       foreach($survey as $dt_result){
                            if($dt_result->kode_wilayah == $wilayah && $dt_result->weight_name == 'IPK' && $dt_result->kode_eselon == '05'){
                             $no = $no+1;
                      ?>
                      <tr>
      ...
      <div class="tab-pane fade" id="nav-imi" role="tabpanel" aria-labelledby="nav-imi-tab">
        <div class="table-responsive mt-3">
                <table class="table table-striped rounded"  width="100%" cellspacing="0">
                      ...
                      $no=0;
                       foreach($survey as $dt_result){
                            if($dt_result->kode_wilayah == $wilayah && $dt_result->weight_name == 'IPK' && $dt_result->kode_eselon == '06'){
                             $no = $no+1;
                      ?>
                      <tr>
                          <td class="py-1 text-center"><?php echo $no?></td>
      ...
      <div class="tab-pane fade show" id="nav-bhp" role="tabpanel" aria-labelledby="nav-bhp-tab">
         <div class="table-responsive mt-3">
                <table class="table table-striped rounded"  width="100%" cellspacing="0">
                      ...
                      $no=0;
                       foreach($survey as $dt_result){
                            if($dt_result->kode_wilayah == $wilayah && $dt_result->weight_name == 'IPK' && $dt_result->kode_eselon == '03'){
                             $no = $no+1;
                      ?>
                      <tr>
                          <td class="py-1 text-center"><?php echo $no?></td>
       ...
       <div class="tab-pane fade show" id="nav-bd" role="tabpanel" aria-labelledby="nav-bd-tab">
         <div class="table-responsive mt-3">
                <table class="table table-striped rounded"  width="100%" cellspacing="0">
                      ...
                      $no=0;
                       foreach($survey as $dt_result){
                            if($dt_result->kode_wilayah == $wilayah && $dt_result->weight_name == 'IPK' && $dt_result->kode_eselon == '12'){
                             $no = $no+1;
                      ?>
                      <tr>
                          <td class="py-1 text-center"><?php echo $no?></td>
