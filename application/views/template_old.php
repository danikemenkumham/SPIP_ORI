        ...
        <ul class="navbar-nav navbar-nav-right ">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?php echo base_url()?>assets/template/images/faces/face5.jpg" alt="profile"/>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="program" style="">
              <ul class="nav flex-column sub-menu">
               ...
               <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('satker/wbk/satker/2020')?>">LKE  &nbsp;<img width="60px" src="<?php echo base_url()?>assets/image/siapzi-1.png" /></a></li>
              <?php }else{?>
               <li class="nav-item"> <a class="nav-link" href="<?php echo site_url('satker/wbk/area/2020')?>">LKE  &nbsp;<img width="60px" src="<?php echo base_url()?>assets/image/siapzi-1.png" /></a></li>
              <?php }?>
