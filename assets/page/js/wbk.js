...
function uploadFile(event,satker, ref,poin_penilaian){
       ...
       $(document).on("change", ".verifikasi",function(){
            ...
            urls = _baseurl+'satker/wbk/verifikasi';
        ...
        $(document).on("click", ".catatan",function(){
            ...
            if(catatan == ''){
                ...
                urls = _baseurl+'satker/wbk/add_catatan';
        ...
        $(document).on('change','.data_pendukusng', function(){
            ...
            form.append('userfile', file);
            $.ajax({
                 url: _baseurl+'satker/wbk/do_upload',
                 type:"post",
                 data:data,
                 processData:false,
                 contentType:false,
        ...
        $(document).on('click','.area', function(){
           ...
           if(satker ==  null || satker ==  ''){
            location.href = ''+_baseurl+'satker/wbk/poin/'+id;
           }else{
            location.href = ''+_baseurl+'satker/wbk/poin/'+id+'/'+satker; 
           }
         ...
         $(document).on('click','.poin', function(){
           ...
           satker = $(this).data('satker');
           if(satker ==  null || satker ==  ''){
             location.href = ''+_baseurl+'satker/wbk/detail/'+id;
           }else{
            location.href = ''+_baseurl+'satker/wbk/detail/'+id+'/'+satker; 
           }
